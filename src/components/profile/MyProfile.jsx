			...
			<div className='container'>
				<div className='row'>
					<div className='col-md-12'>
						...
						<div className='row'>
							<div className='col-md-12'>
								<div className='card card-body bg-profile text-white mb-3'>
									<div className='row'>
							...
							<div className='col-md-12'>
								<div className='card card-body bg-light mb-3'>
									...
									<p className='lead'>
										...
										facere porro esse numquam assumenda doloremque saepe aliquam
										nemo excepturi aliquid maiores! Excepturi, libero
										repudiandae.
									</p>
									<hr />
